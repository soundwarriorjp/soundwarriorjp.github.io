...
window.wpcf7cf = {
    ...
    updateRepeaterSubHTML : function(html, oldSuffix, newSuffix, parentRepeaters) {
        ...
        if (
            ...
            for (let i=0; i<length ;="" `<span="" class="wpcf7cf-index wpcf7cf__${id}" const="" find="parentRepeatersInfo[i][id][0];" i++)="" id="Object.keys(parentRepeatersInfo[i])[0];" repl="parentRepeatersInfo[i][id][1];" replacements.push([="" {="">${find}&lt;\\/span&gt;`,
